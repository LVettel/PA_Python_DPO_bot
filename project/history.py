...
class SearchConfig(Model):
    ...
    command = CharField(max_length=20, null=False, verbose_name='изначальная команда поиска')
    city = CharField(max_length=50, null=False, verbose_name='искомый город')
...
class Results(Model):
    name = CharField(max_length=120, null=False, verbose_name='название отеля')
